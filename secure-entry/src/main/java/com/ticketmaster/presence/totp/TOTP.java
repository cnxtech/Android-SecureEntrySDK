...
public class TOTP {
     ...
     * @param digits length of the password; acceptable values are 6, 7 or 8 otherwise an exception will be thrown
     * @param timeInterval time interval for the generation of the password (i.e window in which the same password should occur)
     * @param algorithm {@link OTPAlgorithm} HMAC algorithm to use when hashing the secret (SHA1, SHA256 & SHA512 are supported)
     * @throws InstantiationException
     */
    public TOTP(ByteBuffer secret, int digits, int timeInterval, OTPAlgorithm algorithm) throws InstantiationException {
        this.secret = secret;
        this.digits = digits;
